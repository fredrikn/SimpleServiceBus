namespace ServiceBus.Hosts.Wcf.Configuration
{
    ...
    public class HttpBasicConfiguration : IHttpBasicConfiguration
    {
        ...
        {
            _configurationReader = ServiceBusHost.Config.Services.GetService<IConfigurationReader>();
        }


        /// <summary>
        /// Gets the Url of the WCF Command reciever service. Default is http://localhost:8080/Command.
